...
def response_to_dataframe(response):
    ...
    for item in results:
        ...
        # Note: As of 7/6/2018 the selling state is showing up only as "Ended" and not the true
        #  sellingStates of either "EndedWithSale" or "EndedWithoutSale". I don't know when this changed.
        #  Note also that WebQueryResult.xml generated by the sub ebayApiQuery() in .\save\findCompletedItems.xlsm
        #  still reflects the correct values for sellingState
